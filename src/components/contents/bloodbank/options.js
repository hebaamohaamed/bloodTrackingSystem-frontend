            ...
            <div className="carousel-inner py-4" >
                <div className="carousel-item active">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-4 d-none d-lg-block" id="newDonation">
                                <div claclassNamess="card">
                                    <img src= {newDonationImg} className="card-img-top" alt="..." />
                            ...
                            <div className="col-lg-4 d-none d-lg-block" id="trackBlood" >
                                <div className="card">
                                    <img src={trackBloodImg} className="card-img-top" alt="..." />
                                    <div className="card-body">
                            ...
                            <div className="col-lg-4 d-none d-lg-block" id="sendBag">
                                <div className="card">
                                    <img src={sendBagImg} className="card-img-top"alt="..."/>
                                    <div className="card-body">
                                        <h5 className="card-title">Send a Blood Bag</h5>
                                        <p className="card-text">
                                            If you need to send a Blood Bag, 
                                            Submit info here.
                                        </p>
                                        <a href="/" className="btn btn-danger">Submit</a>
                                    </div>
